...
public class NotificationConsumer {
    ...
    public void receiveLoanNotification(LoanNotificationDTO notification) {
        ...
        } else if (notification.statusLoan() == StatusLoan.DISPONIVEL_PARA_RETIRADA) {
            subject = "Seu Livro Reservado está Disponível! | Biblioteca NewStack";
            htmlContent = String.format("""
                            <!DOCTYPE html>
                            <html>
                            <body>
                                <h1>Livro Disponível para Retirada!</h1>
                                <p>Olá, %s!</p>
                                <p>O livro <strong>%s</strong>, que você reservou, está agora disponível para retirada na biblioteca.</p>
                                <p>Por favor, retire-o em até 48 horas.</p>
                                <p>Atenciosamente,<br>Equipe NewStack</p>
                            </body>
                            </html>
                            """,
                    notification.clientName(),
